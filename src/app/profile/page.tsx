  ...
  return (
    <div className="page-shell">
      <div className="page-stack">
        <PageHeader
          ...
          actions={
            <form action={signOutAction}>
              <button type="submit" className="flex min-h-11 items-center gap-2 rounded-[1rem] border border-blood-600 bg-blood-600/20 px-4 py-2 font-serif text-sm uppercase tracking-[0.16em] text-blood-600 transition hover:bg-blood-600 hover:text-parchment-200">
          ...
          <ParchmentCard variant="elevated" className="p-8">
            <div className="flex flex-col gap-6 sm:flex-row">
              <div className="flex h-32 w-32 shrink-0 items-center justify-center overflow-hidden rounded-[1.2rem] border-4 border-gold-600 bg-iron-900">
                {profile.avatarUrl ? (
                  <RemoteImage src={profile.avatarUrl} alt="Crest" className="h-full w-full object-cover" />
                ) : (
              ...
              <div className="flex-1">
                ...
                <div className="mt-4 flex flex-wrap gap-3 text-xs uppercase tracking-[0.2em] text-leather-900">
                  <span className="rounded-full border border-gold-600/60 bg-gold-500/10 px-3 py-2">{profile.role || 'patron'}</span>
                  <span className="rounded-full border border-leather-800/50 bg-parchment-100 px-3 py-2">
        ...
        <ParchmentCard variant="elevated" className="p-6">
        ...
        <ParchmentCard variant="elevated" className="p-8 sm:p-12">
          <ProfileFormClient
